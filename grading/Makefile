...
ifeq ($(UNAME_S),Darwin)
	...
	LIBS += $(MAC_LIB_DIR)
	GLLIBS = $(MAC_G_LIB_DIR) -framework OpenGL -framework GLUT
	CXXFLAGS += -Wno-deprecated-declarations $(MAC_INCLUDE_DIR)
	CXXFLAGS2 += -Wno-deprecated-declarations $(MAC_INCLUDE_DIR)
endif
